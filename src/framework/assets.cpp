...
namespace file
{
	...
	{
		return getResourceDirectory("/gfx" + subdir);
	}
	
	boost::filesystem::path getGraphicPath(std::string subdir)
	{
		return getResourceDirectoryPath("/gfx" + subdir);
	}
	...
	std::string getResourceDirectory(std::string subdir)
	{
		return getCurrentWorkingDirectory() + "/resources";
	}
	
	boost::filesystem::path getResourceDirectoryPath(std::string subdir)
	{
		return getCurrentWorkingDirectoryPath.subdir("resources");
	}
